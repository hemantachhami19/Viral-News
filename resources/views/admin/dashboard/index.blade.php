...
@section('js')
    <!--[if lte IE 8]>
    <script src="{{asset('panel/assets/js/excanvas.min.js')}}"></script>
    <![endif]-->

    <script src="{{asset('panel/assets/js/jquery-ui-1.10.3.custom.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/jquery.ui.touch-punch.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/jquery.slimscroll.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/jquery.easy-pie-chart.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/flot/jquery.flot.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/flot/jquery.flot.pie.min.js')}}"></script>
    <script src="{{asset('panel/assets/js/flot/jquery.flot.resize.min.js')}}"></script>
@endsection